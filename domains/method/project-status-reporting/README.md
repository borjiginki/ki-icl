...
A reference to a **different** artifact is written as a domain and an id, never as a path: `project-status-reporting` in the `method` domain, not `../../method/project-status-reporting/README.md`.
